...
CREATE TABLE `t_activity`  (
  ...
  `activity_head` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '' COMMENT '活动头像',
...
CREATE TABLE `t_game`  (
  ...
  `game_head` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '游戏头像',
...
CREATE TABLE `t_gift`  (
  ...
  `gift_head` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '礼包头像',
  `gift_count` int(10) NOT NULL DEFAULT 0 COMMENT '礼包数量',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_message`  (
  ...
  `message_body` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '消息体',
...
CREATE TABLE `t_prize`  (
  ...
  `prize_expiry` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '有效期',
...
CREATE TABLE `t_user`  (
  ...
  `head` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户头像',
  `level` int(10) NOT NULL COMMENT '用户等级',
  `property` int(10) NOT NULL DEFAULT 0 COMMENT '用户资产',
